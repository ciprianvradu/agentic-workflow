...
pub struct App {
    ...
    /// Log of activity events from hook notifications.
    pub activity_log: crate::data::activity::ActivityLog,
    /// Filter and display settings for the activity feed.
    pub activity_filter: crate::data::activity::ActivityFilter,
    /// Scroll offset for the activity event table.
...
impl App {
    pub fn new(repo_paths: Vec<PathBuf>, poll_interval_secs: u64) -> Self {
        ...
        let mut app = App {
            ...
            activity_log: crate::data::activity::ActivityLog::new(),
            activity_filter: crate::data::activity::ActivityFilter::new(),
            activity_scroll: 0,
        };
        app.rebuild_tree();
