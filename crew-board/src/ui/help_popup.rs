...
pub fn draw(frame: &mut Frame, app: &App) {
    ...
    let lines = vec![
        ...
        Line::from(""),
        key_line("Ctrl+F5", "Go to live view (reset scroll)", mod_style),
        key_line("Ctrl+F6", "Statistics popup", mod_style),
        Line::from(""),
        ...
        Line::from(""),
        key_line("t", "Cycle terminal filter", key_style),
        key_line("e", "Cycle event type filter", key_style),
        key_line("f", "Cycle tool name filter", key_style),
